...
tags:
  - projects
  - programmingProjects
image: ../../assets/img/2020-05-23-ac-catches.jpg
...
splash_image: ../../assets/img/2020-05-23-ac-catches.jpg
slug: ac-catches.com
---
...
<ButtonLink url="https://ac-catches.com/" text="Go to AC-Catches.com" />

<iframe
	src="https://ac-catches.com/"
	width="100%"
	height="600px"
	title="ac-catches.com"
></iframe>
...
![Dashboard of controls.](../../assets/img/ac-catches-controls.png)
...
export const Times = ({ times, currentTime }: ITimes) => {
...
![Hour and month graphs.](../../assets/img/ac-catches-times.png)
...
![Example of animations and interactivity.](../../assets/img/ac-catches-animated.gif)

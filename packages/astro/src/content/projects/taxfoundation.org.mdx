...
tags:
  - projects
  - programmingProjects
image: ../../assets/img/taxfoundation-splash.jpg
...
splash_image: ../../assets/img/taxfoundation-splash.jpg
slug: taxfoundation.org
---

import { Picture } from 'astro:assets';
import old from '../../assets/img/2017-02-01-old-tf-site.jpg';
import new from '../../img/2017-02-01-new-tf-site.jpg';
...
<figure className="images__two-side-by-side">
	<Picture
		src={old}
		alt="The previous incarnation of taxfoundation.org."
		aspectRatio={1200 / 1260}
		widths={[400, 800, 1200]}
	...
	<Picture
		src={new}
		alt="The new incarnation of taxfoundation.org."
		aspectRatio={1200 / 1260}
		widths={[400, 800, 1200]}
		sizes="container(min-width: 1200px) 1200px, container(min-width: 800px) 800px,400px"
		formats={['avif', 'webp']}
	/>
	<figcaption>
		Compare the previous version and new version of taxfoundation.org.
	</figcaption>
</figure>
}

...
import tobaccoMap from '../../assets/img/2019-04-11-map.png';
import closeup from '../../assets/img/2019-04-11-closeup.png';
...
<Picture
	src={tobaccoMap}
	alt="US choropleth showing tobacco tax rates."
	aspectRatio={880 / 543}
	widths={[400, 800, 1200]}
...
![Drag those labels!](../../assets/img/2019-04-11-example.gif)

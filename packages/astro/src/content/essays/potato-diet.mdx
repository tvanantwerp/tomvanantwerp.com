...
tags:
  ...
  - Health
  - Diet
image: ../../assets/img/2022-07-17-potato-smiley.jpg
image_alt: A potato that appears as if it is smiling.
---

import { Picture } from 'astro:assets';
import calories from '../../assets/img/2022-07-17-potato-calories.png'
import weight from '../../assets/img/2022-07-17-potato-weight.png'
import calories2 from '../../assets/img/2022-07-27-calories.png'
import loss from '../../assets/img/2022-07-27-weight-loss.png'
...
<Picture
	src={calories}
	alt="Breakdown of calories consumed during my week of potatoes. Very low to begin with, but goes up as I introduced frozen potato foods with oils in them."
	title="Breakdown of calories consumed during my week of potatoes. Very low to begin with, but goes up as I introduced frozen potato foods with oils in them."
	width={1094}
	pictureAttributes={{style: 'aspect-ratio: 1094/542'}}
	widths={[400, 800, 1200]}
...
<Picture
	src={weight}
	alt="Weight and net calories for the past two weeks. For the prior week, net calories are around 0 and weight is stable. During the diet, net calories drops by about 1,000 per day and weight starts going down erratically."
	title="Weight and net calories for the past two weeks. For the prior week, net calories are around 0 and weight is stable. During the diet, net calories drops by about 1,000 per day and weight starts going down erratically."
	width={2156}
	pictureAttributes={{style: 'aspect-ratio: 2156/1018'}}
	widths={[400, 800, 1200]}
	sizes="(min-width: 1200px) 1200px,(min-width: 800px) 800px,400px"
	formats={['png']}
/>
...
<table>
	...
	<tbody>
		<tr>
			<td>B1 (Thiamine)</td>
			<td className="numeric">2.6mg (220%)</td>
			<td className="numeric">1.4mg (114%)</td>
			<td className="numeric">0.6mg (52%)</td>
		</tr>
		<tr>
			<td>B2 (Riboflavin)</td>
			<td className="numeric">1.9mg (143%)</td>
			<td className="numeric">1.5mg (116%)</td>
			<td className="numeric">1.1mg (88%)</td>
		</tr>
		<tr>
			<td>B3 (Niacin)</td>
			<td className="numeric">26.3mg (164%)</td>
			<td className="numeric">20.1mg (126%)</td>
			<td className="numeric">15.2mg (95%)</td>
		</tr>
		<tr>
			<td>B5 (Pantothenic Acid)</td>
			<td className="numeric">9.8mg (197%)</td>
			<td className="numeric">3.4mg (69%)</td>
			<td className="numeric">3.6mg (73%)</td>
		</tr>
		<tr>
			<td>B6 (Pyridoxine)</td>
			<td className="numeric">4.1mg (316%)</td>
			<td className="numeric">1.5mg (114%)</td>
			<td className="numeric">1.2mg (94%)</td>
		</tr>
		<tr>
			<td>B12 (Cobalamin)</td>
			<td className="numeric">6.5µg (269%)</td>
			<td className="numeric">6.2µg (260%)</td>
			<td className="numeric">4.7µg (194%)</td>
		</tr>
		<tr>
			<td>Choline</td>
			<td className="numeric">219.6mg (40%)</td>
			<td className="numeric">352.3mg (64%)</td>
			<td className="numeric">351.3mg (64%)</td>
		</tr>
		<tr>
			<td>Folate</td>
			<td className="numeric">368.8µg (92%)</td>
			<td className="numeric">147.2µg (37%)</td>
			<td className="numeric">109.9µg (27%)</td>
		</tr>
		<tr>
			<td>Vitamin A</td>
			<td className="numeric">1676.9µg (186%)</td>
			<td className="numeric">436.9µg (49%)</td>
			<td className="numeric">350.9µg (39%)</td>
		</tr>
		<tr>
			<td>Vitamin C</td>
			<td className="numeric">130.7mg (65%)</td>
			<td className="numeric">14.5mg (7%)</td>
			<td className="numeric">27.2mg (14%)</td>
		</tr>
		<tr>
			<td>Vitamin D</td>
			<td className="numeric">171.7IU (29%)</td>
			<td className="numeric">366.5IU (61%)</td>
			<td className="numeric">417.3IU (70%)</td>
		</tr>
		<tr>
			<td>Vitamin E</td>
			<td className="numeric">9.8mg (65%)</td>
			<td className="numeric">3.5mg (23%)</td>
			<td className="numeric">6.1mg (41%)</td>
		</tr>
		<tr>
			<td>Vitamin K</td>
			<td className="numeric">53.7µg (45%)</td>
			<td className="numeric">135.2µg (113%)</td>
			<td className="numeric">88.0µg (73%)</td>
		</tr>
		<tr>
			<td>Calcium</td>
			<td className="numeric">244.3mg (24%)</td>
			<td className="numeric">976.3mg (98%)</td>
			<td className="numeric">839.8mg (84%)</td>
		</tr>
		<tr>
			<td>Chromium</td>
			<td className="numeric">25.7µg (73%)</td>
			<td className="numeric">0.0µg (0%)</td>
			<td className="numeric">10.5µg (30%)</td>
		</tr>
		<tr>
			<td>Copper</td>
			<td className="numeric">1.6mg (182%)</td>
			<td className="numeric">0.5mg (53%)</td>
			<td className="numeric">0.7mg (80%)</td>
		</tr>
		<tr>
			<td>Iodine</td>
			<td className="numeric">34.4µg (23%)</td>
			<td className="numeric">64.6µg (43%)</td>
			<td className="numeric">76.2µg (51%)</td>
		</tr>
		<tr>
			<td>Iron</td>
			<td className="numeric">9.6mg (120%)</td>
			<td className="numeric">14.0mg (175%)</td>
			<td className="numeric">8.3mg (104%)</td>
		</tr>
		<tr>
			<td>Magnesium</td>
			<td className="numeric">308.2mg (73%)</td>
			<td className="numeric">189.2mg (45%)</td>
			<td className="numeric">238.8mg (57%)</td>
		</tr>
		<tr>
			<td>Manganese</td>
			<td className="numeric">3.1mg (135%)</td>
			<td className="numeric">0.8mg (35%)</td>
			<td className="numeric">1.0mg (41%)</td>
		</tr>
		<tr>
			<td>Phosphorus</td>
			<td className="numeric">803.7mg (115%)</td>
			<td className="numeric">1096.1mg (157%)</td>
			<td className="numeric">1024.4mg (146%)</td>
		</tr>
		<tr>
			<td>Potassium</td>
			<td className="numeric">5278.3mg (155%)</td>
			<td className="numeric">2642.4mg (78%)</td>
			<td className="numeric">1800.3mg (53%)</td>
		</tr>
		<tr>
			<td>Selenium</td>
			<td className="numeric">20.6µg (37%)</td>
			<td className="numeric">121.3µg (221%)</td>
			<td className="numeric">81.3µg (148%)</td>
		</tr>
		<tr>
			<td>Sodium</td>
			<td className="numeric">2697.7mg (180%)</td>
			<td className="numeric">2501.5mg (167%)</td>
			<td className="numeric">1920.7mg (128%)</td>
		</tr>
		<tr>
			<td>Zinc</td>
			<td className="numeric">11.1mg (101%)</td>
			<td className="numeric">15.2mg (138%)</td>
			<td className="numeric">10.7mg (97%)</td>
		</tr>
	</tbody>
</table>
</details>
...
<details>
<summary>Click here to read about potato poops. 🥔💩</summary>
...
<Picture
	src={calories2}
	alt="You can see the make up of calories in this chart from the potato diet, which was very high carb, and the switch to keto afterward, which is much higher fat and protein with little carbohydrate."
	title="You can see the make up of calories in this chart from the potato diet, which was very high carb, and the switch to keto afterward, which is much higher fat and protein with little carbohydrate."
	width={1200}
	aspectRatio={1200 / 546}
	pictureAttributes={{style: 'aspect-ratio: 1200/546'}}
	widths={[400, 800, 1200]}
	sizes="(min-width: 1200px) 1200px,(min-width: 800px) 800px,400px"
	formats={['png']}
/>
...
<Picture
	src={loss}
	alt="Weight has continued to trend down with no observable difference between the potato diet and keto diet."
	title="Weight has continued to trend down with no observable difference between the potato diet and keto diet."
	width={1200}
	aspectRatio={1200 / 544}
	pictureAttributes={{style: 'aspect-ratio: 1200/542'}}
	widths={[400, 800, 1200]}
	sizes="(min-width: 1200px) 1200px,(min-width: 800px) 800px,400px"
	formats={['png']}
/>

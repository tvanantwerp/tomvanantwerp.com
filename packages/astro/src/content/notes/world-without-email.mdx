...
tags:
  ...
  - Scrum
  - Borders
image: ../../assets/img/2021-03-08-hide-the-pain-harold.jpg
image_alt: 'Hide the Pain Harold meme'
splash_image: ../../assets/img/2021-03-08-open-office.jpg
---

import { Picture } from 'astro:assets';
import scrum from '../../assets/img/2021-03-08-jared-scrum.jpg';
...

{
  ...
  <figure>
    <Picture
      src={scrum}
      alt="The character Jared from the show Silicon Valley explains a Scrum task board to Pied Piper employees."
      title="The character Jared from the show Silicon Valley explains a Scrum task board to Pied Piper employees."
      aspectRatio={957 / 534}
      widths={[400, 800, 1200]}
  ...
  <figcaption>
    Source:{' '}
    <a href="https://amzn.to/3wuwJSL" target="_blank" rel="noopener noreferrer">
      Silicon Valley
    </a>
  </figcaption>
